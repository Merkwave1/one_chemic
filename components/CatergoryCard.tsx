...
const CatergoryCard: React.FC<CatergoryCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl px-4 pt-4 self-start font-bold mb-2 group-hover:underline">
        {title}
      </h3>

      <p className="text-base px-4  self-start">{description}</p>
      <div className="mt-auto self-center w-full flex items-center mb-4 justify-center">
        <span className="mt-2  w-1/2 self-center text-center text-white bg-bluish  px-8 py-2  rounded-lg hover:underline">
