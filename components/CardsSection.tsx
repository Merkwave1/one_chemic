  ...
  return (
    <section className="flex flex-col   w-full h-full gap-4 bg-yellowish relative overflow-hidden">
      ...
      <div className="flex flex-col  text-center items-center justify-center gap-2 mt-12 z-20">
        <h2 className="text-4xl text-bluish font-bold">{isArabic ? "خدمات مصممة خصيصًا لاحتياجاتك" : "Services tailored to your needs"}</h2>
        <p className="text-black text-base">{isArabic ? "لأن رحلتك فريدة، دعمنا كذلك." : "Because your journey is unique, our support is too."}</p>
