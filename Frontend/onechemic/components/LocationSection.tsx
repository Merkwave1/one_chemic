...
const LocationSection: React.FC<LocationSectionProps> = ({ lang }) => {
  ...
  return (
    <div className="relative bg-yellowish h-full w-full py-10 md:py-50 flex flex-col md:flex-row gap-8 md:gap-0">
      <div
        className="
            absolute inset-0 
          ...
          "
      />
      <div className="flex flex-col items-center justify-center  gap-2 md:gap-6 px-2 md:px-30 z-20 md:max-w-[40%]">
        <div className="relative">
          <MapPin className="w-24 h-24 lg:w-36 lg:h-36 text-bluish" />
        </div>
        <h4 className="text-3xl font-extrabold md:text-5xl text-bluish text-center">
      ...
      <div className="px-4 md:px-12 w-full z-20">
        <div className="relative w-full h-[600px] md:h-[450px] rounded-xl border border-bluish shadow-lg">
          <iframe
